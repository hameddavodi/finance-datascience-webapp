...
@csrf_exempt
def portifolio_core(request)->object:
    ...
    return render(request, "Wisdomise.html", {'plotting': plot_html,
                                              'opt_vector': percentage,
                                              'price_latest': price_latest,
                                              'price_bought_date':price_bought_date,
